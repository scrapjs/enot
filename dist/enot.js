...
f.b.pass=function(b,a,c){c=c.split(z).map(w);return function(b){for(var d,g=c.length;g--;){d=c[g];var D="originalEvent"in b?b.originalEvent.which:b.which;if(d in K&&K[d]==D||D==d)return a.call(this,b)}return 1}};f.b.delegate=function(b,a,c){return function(b){var d=b.target;if(!q(d))return 1;for(;d&&d!==this;){if(h(d,c))return b.delegateTarget=d,Object.defineProperty(b,"currentTarget",{get:function(){return d}}),a.call(this,b);d=d.parentNode}return 1}};
