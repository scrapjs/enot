...
function A(c,a,b){var d={},e=a.match(/\w+(?:\:\w+(?:\(.+\))?)*$/)[0];a=a.slice(0,-e.length).trim();var f;(f=c)||(f=y);a&&(/^[.#[]/.test(a)?(q(f)||(f=y),f=f.querySelectorAll(a)):f=/^this\./.test(a)?B(f,a.slice(5)):a[0]===C?B(f,a.slice(1)):"this"===a?f:a===C?f:/^body|^html/.test(a)?document.querySelectorAll(a):"root"===a?y.documentElement:B(x,a));d.c=f;e=v(e,"on").split(":");d.a=e.shift();d.b=e;b&&(p(b)&&(b=E(b,c)),d.d=F(b,d.a,d.b));return d}var C="@";
