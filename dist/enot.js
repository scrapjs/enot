...
function w(a,b){var c=a;b.b.sort(function(d){return/^one/.test(d)?1:-1}).forEach(function(d){var a=d.split("(")[0];d=d.slice(a.length+1,-1);f.b[a]&&(c=f.b[a](b.a,c,d))});return c}var x=new WeakMap,y=new WeakMap;f.on=function(a,b,c){m(a)&&(c=b,b=a,a=null);if(!b)return!1;k(b,function(d){z(a,d,c)})};var A={};
function z(a,b,c){var d=t(a,b,c);a=d.c;var e=d.d;if(a)if(a.length&&!n(a))for(b=a.length;b--;)z(a[b],d.a,e);else{void 0===c&&(e=c=a[d.a]);if(m(c))e=f.b.fire(b,null,c),(A[c]=A[c]||{})[d.a]=e;else if(e!==c){x.has(c)||x.set(c,{});b=x.get(c);if(b[d.a])return;b[d.a]=e}d=d.a;if(a&&a.addEventListener)if($)$(a).on(d,e);else a.addEventListener(d,e);else y.has(a)||y.set(a,{}),a=y.get(a),(a[d]=a[d]||[]).push(e)}}f.off=function(a,b,c){m(a)&&(c=b,b=a,a=null);b&&k(b,function(d){B(a,d,c)})};
function B(a,b,c){var d=t(a,b);a=d.c;b=c;if(a)if(a.length&&!n(a))for(c=a.length;c--;)B(a[c],d.a,b);else if(void 0===c&&(b=c=a[d.a]),m(c)?A[c]&&(b=A[c][d.a],A[c][d.a]=null):x.has(c)&&(c=x.get(c),c[d.a]&&(b=c[d.a],c[d.a]=null)),d=d.a,a&&a.addEventListener)$?$(a).off(d,b):a.removeEventListener(d,b);else if(y.has(a)&&(a=y.get(a)[d]))for(d=0;d<a.length;d++)if(a[d]===b){a.splice(d,1);break}}
f.fire=function(a,b,c,d){m(a)&&(d=c,c=b,b=a,a=null);if(b instanceof Event)return C(a,b);if(!b)return!1;k(b,function(b){var g=t(a,b);return g.a?w(function(){var a=g.c;if(!a)return a;if(a.length&&!n(a))for(var b=a.length;b--;)C(a[b],g.a,c,d);else C(a,g.a,c,d)},g)():!1})};
...
f.b.pass=function(a,b,c){c=c.split(s).map(E);return function(a){for(var e,g=c.length;g--;){e=c[g];var D="originalEvent"in a?a.originalEvent.which:a.which;if(e in r&&r[e]==D||D==e)return b.call(this,a)}return 1}};f.b.delegate=function(a,b,c){return function(a){var e=a.target;if(!n(e))return 1;for(;e&&e!==this;){if(h(e,c))return a.delegateTarget=e,Object.defineProperty(a,"currentTarget",{get:function(){return e}}),b.call(this,a);e=e.parentNode}return 1}};
f.b.not=function(a,b,c){return function(a){for(var e=a.target;e&&e!==this;){if(h(e,c))return 1;e=e.parentNode}return b.call(this,a)}};var F=new WeakMap;f.b.throttle=function(a,b,c){c=parseFloat(c);return function(a){var e=this;if(F.get(e))return 1;a=b.call(e,a);if(1===a)return a;F.set(e,setTimeout(function(){clearInterval(F.e);F.delete(e)},c))}};f.b.defer=function(a,b,c){c=parseFloat(c);return function(a){var e=this;setTimeout(function(){return b.call(e,a)},c)}};
f.b.fire=function(a,b,c){var d=c+"";return function(a){var b=this;k(d,function(c){C(b,c,a.detail)})}};function E(a){return a.toUpperCase()};
