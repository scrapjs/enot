...
function A(b,a,c){var e={},d=a.match(/\w+(?:\:\w+(?:\(.+\))?)*$/)[0];a=a.slice(0,-d.length).trim();b||(b=x);a=a?/^[.#[]/.test(a)&&y?y.querySelectorAll(a):/^this\./.test(a)?B(b,a.slice(5)):a[0]===C?B(b,a.slice(1)):"this"===a?b:a===C?b:"body"===a?y.body:"root"===a?y.documentElement:B(x,a):b;e.c=a;d=v(d,"on").split(":");e.a=d.shift();e.b=d;c&&(p(c)&&(c=E(c)),e.d=F(c,e.a,e.b));return e}var C="@";function B(b,a){for(var c=a.split("."),e=b,d;void 0!==(d=c.shift());){if(!r(e,d))return;e=e[d]}return e}
function F(b,a,c){var e=b;c.sort(function(a){return/^one/.test(a)?1:-1}).forEach(function(c){var b=c.split("(")[0];c=c.slice(b.length+1,-1);f.b[b]&&(e=f.b[b](a,e,c))});return e}var G=new WeakMap;f.on=function(b,a,c){p(b)&&(c=a,a=b,b=null);if(!a)return!1;k(a,function(a){H(b,a,c)})};var I=new WeakMap;
...
f.b.pass=function(b,a,c){c=c.split(z).map(w);return function(b){for(var d,g=c.length;g--;){d=c[g];var D="originalEvent"in b?b.originalEvent.which:b.which;if(d in K&&K[d]==D||D==d)return a.call(this,b)}return 1}};f.b.delegate=function(b,a,c){return function(b){var d=b.target;if(!q(d))return 1;for(;d&&d!==document&&d!==this;){if(h(d,c))return b.delegateTarget=d,Object.defineProperty(b,"currentTarget",{get:function(){return d}}),a.call(this,b);d=d.parentNode}return 1}};
f.b.not=function(b,a,c){return function(b){for(var d=b.target;d&&d!==document&&d!==this;){if(h(d,c))return 1;d=d.parentNode}return a.call(this,b)}};var L=new WeakMap;f.b.throttle=function(b,a,c){c=parseFloat(c);return function(b){var d=this;if(L.get(d))return 1;b=a.call(d,b);if(1===b)return b;L.set(d,setTimeout(function(){clearInterval(L.e);L.delete(d)},c))}};f.b.defer=function(b,a,c){c=parseFloat(c);return function(b){var d=this;setTimeout(function(){return a.call(d,b)},c)}};
