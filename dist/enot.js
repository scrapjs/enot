...
function A(b,a,c){var e={},d=a.match(/\w+(?:\:\w+(?:\(.+\))?)*$/)[0];a=a.slice(0,-d.length).trim();b||(b=y);a?/^[.#[]/.test(a)?(q(b)||(b=y),a=b.querySelectorAll(a)):a=/^this\./.test(a)?B(b,a.slice(5)):a[0]===C?B(b,a.slice(1)):"this"===a?b:a===C?b:/^body|^html/.test(a)?document.querySelectorAll(a):"root"===a?y.documentElement:B(x,a):a=b;e.c=a;d=v(d,"on").split(":");e.a=d.shift();e.b=d;c&&(p(c)&&(c=E(c)),e.d=F(c,e.a,e.b));return e}var C="@";
function B(b,a){for(var c=a.split("."),e=b,d;void 0!==(d=c.shift());){if(!r(e,d))return;e=e[d]}return e}function F(b,a,c){var e=b;c.sort(function(a){return/^one/.test(a)?1:-1}).forEach(function(c){var g=c.split("(")[0];c=c.slice(g.length+1,-1);f.b[g]&&(e=f.b[g](a,e,c,b))});return e}var G=new WeakMap;f.on=function(b,a,c){p(b)&&(c=a,a=b,b=null);if(!a)return!1;k(a,function(a){H(b,a,c)})};var I=new WeakMap;
